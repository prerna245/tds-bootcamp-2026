...
--- Before Day-3 ---
I already knew write and run simple Python scripts, install packages using pip, and use virtual environments created with venv.
---   
...
uv provides me faster and simpler workflow for Python dependency management than traditional pip-based setups.
Modern Python projects increasingly rely on pyproject.toml than any
we should choose correct Python interpretr in VS Code is important to ensure that the expected packages and environment are used.
---
...
project from scratch using uv init.
uv commands and configuration options
