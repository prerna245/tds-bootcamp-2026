...
--- Before Day-5 ---
I already knew to make a commit: 'git add' → 'git commit -m "message"' → 'git push'
--- 
...
understand git and now i can use it by myself, and Git tracks changes through snapshots rather than storing complete copies of files every time.
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback ...
The session was well-structured and practical
---
